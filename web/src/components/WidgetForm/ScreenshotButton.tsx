...
export function ScreenshotButton({screenshot, onScreenshotTook} : ScreenshotButtonProps){
  ...
  async function handleTakeScreenshot(){
    ...
    // o query selector pode retornar o elemento buscado e caso não exista
    // ele retorna null, o ! após o query selector é um operador de negação
    // então eu estou "garantindo" que o elemento exista
  ...
  return (
    <button
      ...
      transition-colors focus:outline-none text-zinc-100
